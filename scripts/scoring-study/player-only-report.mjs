...
<p>With every building standing, the building bonus would have paid ${n(possibleBuilding)}. Building losses cost only <strong>${n(t.forfeitedBuildingBonus)} points (${share(t.forfeitedBuildingBonus)} of all points)</strong>, so ${share(t.buildingBonus, possibleBuilding, 0)} of the building bonus is paid simply for surviving the wave. In practice the building bonus is a second, larger wave-survival bonus: protecting buildings moves the score very little.</p>

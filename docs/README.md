...
- [`rm-04-retention-and-manual-deletion-plan.md`](./rm-04-retention-and-manual-deletion-plan.md) — implementation and verification plan for RM-04's 365/270/90-day policy, public-share expiry, and resumable operator deletion across D1 and R2.
- [`operator-replay-inspection.md`](./operator-replay-inspection.md) — operator UI workflow, curated session endpoints, paging and replay limitations.
- [`rm-08-replay-inspection-ui-plan.md`](./rm-08-replay-inspection-ui-plan.md) — active implementation contract for filtering retained captures, inspecting privacy-minimised run and per-wave evidence, seeking deterministic playback, and opening private RM-06 candidates through the operator UI.

  ...
  return {
    ...
    missiles: [
      ...
      },
      {
        ...
        type: "missile",
        variant: "fast",
        trail: Array.from({ length: 12 }, (_, i) => ({ x: 460 - i * 0.2, y: 220 - i * 2.6 })),
      },
    ],
    drones: [
      {
      ...
      },
      {
        ...
        type: "drone",
        subtype: "shahed136",
        shahedVariant: "shahed-136-bomber",
        health: 2,
        collisionRadius: 30,
        wobble: 0,
        heading: 0.2,
      ...
      },
      {
        ...
        type: "drone",
        subtype: "shahed136",
        shahedVariant: "shahed-136-dive-bomber",
        health: 2,
        collisionRadius: 30,
        wobble: 0,
        heading: 0.2,

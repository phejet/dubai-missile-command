...
export const UPGRADE_NODES: UpgradeNodeDef[] = [
  ...
  },
  {
    ...
    icon: "\uD83D\uDEE1\uFE0F",
    desc: "Refit the launchers for a larger ready rack so the player can absorb longer waves before running dry.",
    cost: 805,
    color: COL.launcherKit,
    statLine: "Extended Mag: +50% ammo per wave",
  },
  {
    id: "launcherArmorKit",
    family: "launcherKit",
  ...
  {
    id: "launcherDeepMagazine",
    family: "launcherKit",
    rank: 3,
    name: "Deep Magazine",
    icon: "\uD83D\uDEE1\uFE0F",
    desc: "Final magazine upgrade doubles per-wave capacity so the battery can stay lethal under sustained pressure.",
    cost: 3024,
    color: COL.launcherKit,
    statLine: "Deep Magazine: +100% ammo per wave",
    allOf: ["launcherKit", "launcherArmorKit"],
  },
  {
    id: "emp",
    family: "emp",

...
export const PARAM_GROUPS = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "burjFire.emberSize", label: "Ember Size", type: "range", min: 0.6, max: 8, step: 0.1, default: 2.8 },
      { key: "burjFire.smokeRate", label: "Smoke Rate", type: "range", min: 0, max: 4, step: 0.05, default: 0.42 },
      { key: "burjFire.smokeLife", label: "Smoke Life", type: "range", min: 60, max: 420, step: 5, default: 220 },
      { key: "burjFire.smokeSize", label: "Smoke Size", type: "range", min: 2, max: 32, step: 0.5, default: 14 },
      { key: "burjFire.smokeRise", label: "Smoke Rise", type: "range", min: 0.1, max: 2, step: 0.05, default: 0.7 },
      { key: "burjFire.smokeDrift", label: "Smoke Drift", type: "range", min: 0, max: 0.8, step: 0.01, default: 0.18 },

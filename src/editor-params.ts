...
export const PARAM_GROUPS = [
  ...
  },
  {
    name: "Burj Fire",
    params: [
      { key: "burjFire.flameRate", label: "Flame Rate", type: "range", min: 0, max: 8, step: 0.1, default: 2.4 },
      { key: "burjFire.flameLife", label: "Flame Life", type: "range", min: 6, max: 60, step: 1, default: 16 },
      { key: "burjFire.flameSize", label: "Flame Size", type: "range", min: 2, max: 28, step: 0.5, default: 10 },
      ...
      { key: "burjFire.emberSize", label: "Ember Size", type: "range", min: 0.6, max: 8, step: 0.1, default: 2.2 },
      { key: "burjFire.smokeRate", label: "Smoke Rate", type: "range", min: 0, max: 4, step: 0.05, default: 0.55 },

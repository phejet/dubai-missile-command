...
export const PARAM_GROUPS = [
  ...
  },
  {
    name: "Burj Fire",
    params: [
      { key: "burjFire.flameRate", label: "Flame Rate", type: "range", min: 0, max: 8, step: 0.1, default: 0.1 },
      ...
      { key: "burjFire.emberSize", label: "Ember Size", type: "range", min: 0.6, max: 8, step: 0.1, default: 2.9 },
      { key: "burjFire.smokeRate", label: "Smoke Rate", type: "range", min: 0, max: 4, step: 0.05, default: 0.75 },
      { key: "burjFire.smokeLife", label: "Smoke Life", type: "range", min: 60, max: 420, step: 5, default: 225 },

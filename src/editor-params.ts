...
export const PARAM_GROUPS = [
  ...
  },
  {
    name: "Burj Fire",
    params: [
      { key: "burjFire.flameRate", label: "Flame Rate", type: "range", min: 0, max: 8, step: 0.1, default: 5.2 },
      { key: "burjFire.flameLife", label: "Flame Life", type: "range", min: 6, max: 60, step: 1, default: 20 },
      { key: "burjFire.flameSize", label: "Flame Size", type: "range", min: 2, max: 28, step: 0.5, default: 8.5 },
      { key: "burjFire.emberRate", label: "Ember Rate", type: "range", min: 0, max: 5, step: 0.05, default: 1.8 },
      { key: "burjFire.emberLife", label: "Ember Life", type: "range", min: 12, max: 120, step: 2, default: 30 },
      { key: "burjFire.emberSize", label: "Ember Size", type: "range", min: 0.6, max: 8, step: 0.1, default: 0.9 },
      { key: "burjFire.smokeRate", label: "Smoke Rate", type: "range", min: 0, max: 4, step: 0.05, default: 0.4 },
      { key: "burjFire.smokeLife", label: "Smoke Life", type: "range", min: 60, max: 420, step: 5, default: 330 },
      { key: "burjFire.smokeSize", label: "Smoke Size", type: "range", min: 2, max: 32, step: 0.5, default: 7.5 },
      { key: "burjFire.smokeRise", label: "Smoke Rise", type: "range", min: 0.1, max: 2, step: 0.05, default: 0.7 },
      {

...
test.describe("Graphics editor", () => {
  ...
  test("shows the generated startup sprite atlas beside the live editor preview", async ({ page }) => {
    ...
    await expect(atlas.locator("[data-sprite-id^='effect:interceptor-smoke:whitePuff']")).toHaveCount(25);
    await expect(atlas.locator("[data-sprite-id^='effect:threat-explosion:explosion']")).toHaveCount(9);
